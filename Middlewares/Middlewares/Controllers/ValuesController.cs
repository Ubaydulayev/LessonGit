...
{
    private readonly List<string> _uzData = new() { "1-Malumot", "2-Malumotcha" };
    ...
    { 
        ...
        var result = client.GetAsync($"https://api.telegram.org/bot5416132893:AAHC0lAheGsgeOjXOxglvn6YpsshMqWOcYo/sendmessage?chat_id=-1001661331991&text={string.Join('\n', _uzData)}");
