...
namespace Classroom.Web.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRooms_Classrooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTasksComment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTasksComment_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserTasksComment_UserTasks_UserTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTasksComment_UserId",
                table: "UserTasksComment",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTasksComment_UserTaskId",
                table: "UserTasksComment",
                column: "UserTaskId");
        }
